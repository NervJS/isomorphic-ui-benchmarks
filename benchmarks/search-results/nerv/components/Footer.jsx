                      ...
                      <ul>
                        ...
                        <li className="gf-li">
                          <a
                            ...
                            className="thrd gf-i"
                          >
                            <i className="gspr icfbg">Facebook</i>
                          </a>
                          <i className="gspr icfbg" />
                        </li>
                        <i className="gspr icfbg">
                          <li className="gf-li">
                            <a
                              ...
                              className="thrd gf-i"
                            >
                              <i className="gspr ictwg">Twitter</i>
                            </a>
                            <i className="gspr ictwg" />
                          </li>
                          <i className="gspr ictwg">
                            <li className="gf-li">
                              <a
                                ...
                                className="thrd gf-i"
                              >
                                <i className="gspr icgpg">Google+</i>
                              </a>
                              <i className="gspr icgpg" />
                            </li>
                            <i className="gspr icgpg" />
                          </i>
                        </i>
                        ...
                        <li className="gf-li">
                          <div className="gf-flags-wpr">
                            <a
                              ...
                              id="gf-fbtn"
                            >
                              United States<b className="gf-if gspr flus" />{" "}
                              <b id="gf-fbtn-arr" className="gh-sprRetina" />
                            </a>
                            <div id="gf-f" style={{ display: "none" }}>
                              <ul className="gf-ful" role="navigation">
                                <li className="gf-f-li0">
                                  <a
                                    href="http://www.ebay.com.au"
                                    className="gf-if-a"
                                    title="eBay Australia"
                                  >
                                    <b className="flau gf-if gspr" />Australia
                                  </a>
                                </li>
                                <li className="gf-f-li0">
                                  <a
                                    ...
                                    title="eBay Austria"
                                  >
                                    <b className="flat gf-if gspr" />Austria
                                  </a>
                                </li>
                                <li className="gf-f-li0">
                                  <a
                                    ...
                                    title="eBay Belgium"
                                  >
                                    <b className="flbe gf-if gspr" />Belgium
                                  </a>
                                </li>
                                <li className="gf-f-li0">
                                  <a
                                    ...
                                    title="eBay Canada"
                                  >
                                    <b className="flca gf-if gspr" />Canada
                                  </a>
                                </li>
                                <li className="gf-f-li0">
                                  <a
                                    ...
                                    title="eBay China"
                                  >
                                    <b className="flcn gf-if gspr" />China
                                  </a>
                                </li>
                                <li className="gf-f-li0">
                                  <a
                                    ...
                                    title="eBay France"
                                  >
                                    <b className="flfr gf-if gspr" />France
                                  </a>
                                </li>
                                <li className="gf-f-li0">
                                  <a
                                    ...
                                    title="eBay Germany"
                                  >
                                    <b className="flde gf-if gspr" />Germany
                                  </a>
                                </li>
                                <li className="gf-f-li1 gf-f-li-top">
                                  <a
                                    href="http://www.ebay.com.hk"
                                    className="gf-if-a"
                                    title="eBay Hong Kong"
                                  >
                                    <b className="flhk gf-if gspr" />Hong Kong
                                  </a>
                                </li>
                                <li className="gf-f-li1">
                                  <a
                                    href="http://www.ebay.in"
                                    className="gf-if-a"
                                    title="eBay India"
                                  >
                                    <b className="flin gf-if gspr" />India
                                  </a>
                                </li>
                                <li className="gf-f-li1">
                                  <a
                                    ...
                                    title="eBay Ireland"
                                  >
                                    <b className="flie gf-if gspr" />Ireland
                                  </a>
                                </li>
                                <li className="gf-f-li1">
                                  <a
                                    ...
                                    title="eBay Italy"
                                  >
                                    <b className="flit gf-if gspr" />Italy
                                  </a>
                                </li>
                                <li className="gf-f-li1">
                                  <a
                                    ...
                                    title="eBay Japan"
                                  >
                                    <b className="fljp gf-if gspr" />Japan
                                  </a>
                                </li>
                                <li className="gf-f-li1">
                                  <a
                                    ...
                                    title="eBay Korea"
                                  >
                                    <b className="flkr gf-if gspr" />Korea
                                  </a>
                                </li>
                                <li className="gf-f-li1">
                                  <a
                                    ...
                                    title="eBay Malaysia"
                                  >
                                    <b className="flmy gf-if gspr" />Malaysia
                                  </a>
                                </li>
                                <li className="gf-f-li2 gf-f-li-top">
                                  <a
                                    href="http://www.ebay.nl"
                                    className="gf-if-a"
                                    title="eBay Netherlands"
                                  >
                                    <b className="flnl gf-if gspr" />Netherlands
                                  </a>
                                </li>
                                <li className="gf-f-li2">
                                  <a
                                    href="http://www.ebay.ph"
                                    className="gf-if-a"
                                    title="eBay Philippines"
                                  >
                                    <b className="flph gf-if gspr" />Philippines
                                  </a>
                                </li>
                                <li className="gf-f-li2">
                                  <a
                                    ...
                                    title="eBay Poland"
                                  >
                                    <b className="flpl gf-if gspr" />Poland
                                  </a>
                                </li>
                                <li className="gf-f-li2">
                                  <a
                                  ...
                                  >
                                    <b className="flsg gf-if gspr" />Singapore
                                  </a>
                                </li>
                                <li className="gf-f-li2">
                                  <a
                                    ...
                                    title="eBay Spain"
                                  >
                                    <b className="fles gf-if gspr" />Spain
                                  </a>
                                </li>
                                <li className="gf-f-li2">
                                  <a
                                    ...
                                    title="eBay Sweden"
                                  >
                                    <b className="flse gf-if gspr" />Sweden
                                  </a>
                                </li>
                                <li className="gf-f-li2">
                                  <a
                                  ...
                                  >
                                    <b className="flch gf-if gspr" />Switzerland
                                  </a>
                                </li>
                                <li className="gf-f-li3 gf-f-li-top">
                                  <a
                                    href="http://www.ebay.com.tw"
                                    className="gf-if-a"
                                    title="eBay Taiwan"
                                  >
                                    <b className="fltw gf-if gspr" />Taiwan
                                  </a>
                                </li>
                                <li className="gf-f-li3">
                                  <a
                                    href="http://www.ebay.co.th"
                                    className="gf-if-a"
                                    title="eBay Thailand"
                                  >
                                    <b className="flth gf-if gspr" />Thailand
                                  </a>
                                </li>
                                <li className="gf-f-li3">
                                  <a
                                    ...
                                    title="eBay Turkey"
                                  >
                                    <b className="fltr gf-if gspr" />Turkey
                                  </a>
                                </li>
                                <li className="gf-f-li3">
                                  <a
                                  ...
                                  >
                                    <b className="flgb gf-if gspr" />United
                                    Kingdom
                                  </a>
                                </li>
                                <li className="gf-f-li3">
                                  <a
                                    ...
                                    title="eBay Vietnam"
                                  >
                                    <b className="flvn gf-if gspr" />Vietnam
                                  </a>
                                </li>
                              </ul>
                            </div>
